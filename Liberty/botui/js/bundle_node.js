...
function fetchmsg(butt) {
  ...
  fetch(url, {
    ...
    serverMessage(response.Reply); //speechSynthesis.speak( new SpeechSynthesisUtterance(response.Reply))
...
},{"node-fetch":2,"url-search-params-polyfill":3}],2:[function(require,module,exports){
(function (global){
"use strict";
